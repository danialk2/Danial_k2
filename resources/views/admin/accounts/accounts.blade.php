                ...
                <section class="section">
                    <div class="section-header">
                        <div class="bun d-flex">
                            <h1>Accounts</h1>
                            <a class="btn btn-outline-primary ml-3" href="addaccounts"
                                role="button"><i class="fa fa-plus mr-2" aria-hidden="true"></i> New Account
                            </a>
                        </div>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="events">Accounts</a></div>
                        </div>
                    </div>
                </section>
