...
<head>
    ...
    <title>{{config('app.name')}} - New Merchants</title>
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="bun d-flex">
                            ...
                            <h1>Add New Merchants</h1>
                        </div>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="partners">Merchants</a> >
                                <b>Add Merchants</b>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="imageset">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input class="form-control @error('file') is-invalid border-danger @enderror" type="file" id="formFile" name="file" onchange="readURL(this);">
                                    @error('file')
                                        <span class="invalid-feedback mb-2 mt-0" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                                    <div class="container mt-4" style="width:40% ;object-fit: contain;">
                                        <img class="left" id="blah" src="{{URL::to('/')}}/asset/img/placehold.jpg"
                                            alt="activity-image" style="width: 100%;" >
                                    </div>
                                </div>
                            </div>
                        </div>
