...
<head>
    ...
    <title>Kruistraat | Partners</title>
...
<body>
    <div id="app">
        <div class="main-wrapper">
            ...
            @include('admin.partners.sidebar')
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="bun d-flex">
                            <h1>Partners</h1>
                            <a class="btn btn-outline-primary ml-3" href="addpartners"
                                role="button"><i class="fa fa-plus mr-2" aria-hidden="true"></i> New Partners
                            </a>
                        </div>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="events">Partners</a></div>
                        </div>
                    </div>
                </section>
                            ...
                            <table class="table" id="eventTable">
                                <thead>
                                    <tr style="background-color: #6777ef">
                                        ...
                                        <th class="text-white" scope="col" style="max-width: 50%"><b>Partner Name</b></th>
                                        <th class="text-white" scope="col" style="max-width: 50%"><b>Partner ID</b></th>
                                        <th class="text-white" scope="col" style="max-width: 50%"><b>General Information</b></th>
                                        <th class="text-white" scope="col"><b>Facebook Link</b></th>
                                        <th class="text-white" scope="col"><b>Instagram Link</b></th>
