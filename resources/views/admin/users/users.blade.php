                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="events">Users</a></div>
                        </div>
                    </div>
                </section>
                            ...
                            <table class="table" id="eventTable">
                                <thead>
                                    <tr style="background-color: #6777ef">
                                        ...
                                        <th class="text-white" scope="col" style="max-width: 50%"><b>User Name</b></th>
                                        <th class="text-white" scope="col" style="max-width: 50%"><b>User ID</b></th>
